...
def test_debe_verificar_que_se_elimino_el_token_en_el_repositorio():
    ...
    crear_sesion_de_prueba(context.sesion_repository, hash_token="hashed_token_de_prueba", user_agent="test")
    ...
    assert context.sesion_repository.token_eliminado == refresh_token_hash