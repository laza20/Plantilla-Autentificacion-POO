...
def test_eliminar_sesion_correctamente():
    ...
    sesion_insertada = crear_sesion_de_prueba(context.sesion_repository)
    ...
    assert context.sesion_repository.token_eliminado == sesion_insertada.hash_refresh_token
...
def test_eliminar_sesion_que_no_existe():
    ...
    assert context.sesion_repository.fue_llamado is True
    assert context.sesion_repository.token_eliminado == None
